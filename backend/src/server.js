...
const typeDefs = `
  type Query {
    employees(filter: FilterInput, first: Int, after: String, last: Int, before: String): EmployeePage!
  }
...
const resolvers = {
  Query: {
    employees: (_, { filter, first, after, last, before }) =>
      getEmployees(sql, filter, first, after, last, before),
  },
  Mutation: {
